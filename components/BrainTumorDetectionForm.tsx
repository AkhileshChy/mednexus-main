...
// import { TumorAnalysis, APIResponse, Model, Prediction } from '../types';

// const models: Model[] = [
//   { 
//     id: 'brain_tumor_1', 
//     name: 'Brain Tumor', 
//     endpoint: 'https://detect.roboflow.com/brain_tumor-oaw38/1',
//     description: 'Detects brain tumors in MRI scans'
//   },
//   { 
//     id: 'brain_tumor_2', 
//     name: 'Brain Tumor 2', 
//     endpoint: 'https://detect.roboflow.com/brain-tumor-m2pbp/1',
//     description: 'Detects brain tumors in MRI scans'
//   },
//   { 
//     id: 'brain_tumor_3', 
...
// export function BrainTumorAdvancedDetectionForm() {
...
//   const [tumorAnalysis, setTumorAnalysis] = useState<TumorAnalysis | null>(null);
...
//       const response = await axios.post('http://127.0.0.1:5000/brain_tumor', formData, {
//         headers: {
...
//       setTumorAnalysis(response.data.tumor_analysis);
...
//                       <h2 className="text-2xl font-bold mb-4">Tumor Analysis Results</h2>
//                       <div className="space-y-4">
//                         <div>
...
//                             {tumorAnalysis.description}
//                           </p>
//                         </div>
//                         <div>
//                           <h3 className="text-xl font-semibold mb-2">Next Steps</h3>
//                           <ul className="list-disc list-inside space-y-2">
//                             {tumorAnalysis.next_steps.map((step, index) => (
...
import { Badge } from "@/components/ui/badge";
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from "@/components/ui/dialog";
import { Loader2, Upload, Camera, Zap, RotateCcw, Save, Share2, Download, Maximize2, ChevronLeft, ChevronRight } from "lucide-react";
import { TumorAnalysis } from '../types';
...
export function BrainTumorAdvancedDetectionForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setImageHistory(prev => [...prev, previewUrl!]);
      setCurrentImageIndex(prev => prev + 1);
    } catch (err) {
      setError(err instanceof Error ? err.message : 'An error occurred while processing the image');
      setProcessedImageUrl(null);
              ...
              {(previewUrl || processedImageUrl) && (
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                      <Button variant="outline" size="sm" onClick={() => setShowComparison(!showComparison)}>
                        {showComparison ? 'Hide' : 'Show'} Image
                      </Button>
                    </div>
                  </div>
                  {showComparison && (
                    <div ref={fullscreenRef} className="relative">
                      <div>
                        ...
                        <img src={previewUrl!} alt="MRI Scan" className="w-full h-auto rounded-lg shadow-lg" />
                      </div>
                      <div className="absolute top-2 right-2 flex space-x-2">
                        <Button variant="outline" size="icon" onClick={toggleFullscreen}>
                          <Maximize2 className="h-4 w-4" />
